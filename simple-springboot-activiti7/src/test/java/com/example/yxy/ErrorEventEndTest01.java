...
class ErrorEventEndTest01 {
    ...
    void testDeploy() throws FileNotFoundException, InterruptedException {
        ...
        Deployment deploy = repositoryService.createDeployment()
                .key("event-error-end-test01")
                //加载相对路径
                .addClasspathResource("process/event-error-end-test01.bpmn20.xml")
                .name("事件-错误-结束-测试01")
                .deploy();
    ...
    void testQueryTask2(){
        ...
        TaskService taskService = defaultProcessEngine.getTaskService();
        List<Task> taskList = taskService.createTaskQuery()
                .processInstanceId("10f0ffa2-2306-11ef-b562-aa82f9a380a8")
                .list();
        for (Task task : taskList) {
            /**
             *
    ...
    void completeTask2(){
        ProcessEngine defaultProcessEngine = ProcessEngines.getDefaultProcessEngine();
        TaskService taskService = defaultProcessEngine.getTaskService();
        String taskId = "10f98b2d-2306-11ef-b562-aa82f9a380a8";
        Map<String, Object> variables = new HashMap<>();
        variables.put("payFlag",false);
