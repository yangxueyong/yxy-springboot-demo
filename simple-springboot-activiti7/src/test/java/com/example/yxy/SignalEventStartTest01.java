...
class SignalEventStartTest01 {
    ...
    void testDeploy() throws FileNotFoundException, InterruptedException {
        ...
        Deployment deploy = repositoryService.createDeployment()
                .key("event-signal-start-test01")
                //加载相对路径
                .addClasspathResource("process/event-signal-start-test01.bpmn20.xml")
                .name("事件-信号启动流程-测试01")
                .deploy();
     ...
     */
    @Test
    void startProcessBySignal() throws FileNotFoundException {
        //使用流程定义id启动流程
        ProcessEngine defaultProcessEngine = ProcessEngines.getDefaultProcessEngine();
        ...
        List<ProcessInstance> processInstanceList = runtimeService
                ...
                .processDefinitionKey("event-signal-start-test01")
                .list();
        /**
         *
         */
